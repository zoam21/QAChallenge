			...
			"test-run": {
				"browser-console-messages.js": function (exports, module, require) {
					...
					var BrowserConsoleMessages = function () {
					    ...
					    BrowserConsoleMessages.prototype._ensureWindowIdMessageContainer = function _ensureWindowIdMessageContainer(windowId) {
					    ...
					    BrowserConsoleMessages.prototype.concat = function concat(consoleMessages) {
					        ...
					        Object.keys(consoleMessages).forEach(function (windowId) {
					            _this._ensureWindowIdMessageContainer(windowId);
